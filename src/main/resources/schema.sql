-- TODO Create een opzet voor de H2 Database
...
CREATE UNIQUE INDEX 'iban_UNIQUE' ON 'rekening' ('iban' ASC) VISIBLE;
...
CREATE UNIQUE INDEX 'gebruikersNaam_UNIQUE' ON 'klant' ('gebruikersNaam' ASC) VISIBLE;
